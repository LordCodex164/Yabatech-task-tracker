...
const AssignForm = ({close, username, email}: AssignFormProps) => {
  ...
  return (
    <>
    <div className='fixed right-0 top-0 bottom-0 shadow-transparent bg-blue-300 px-5 py-10  lg:min-w-[450px] animate-slide-in-right translate-x-[6px] before:translate-x-[-66px] duration-150 transition-transform after:translate-x-[66px]'>
       {/* let create the menu */}
