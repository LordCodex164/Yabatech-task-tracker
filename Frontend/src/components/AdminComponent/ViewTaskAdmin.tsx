...
const ViewTaskAdmin = ({staffId, specificStaff, close, open}: any) => {
  ...
  return (
    <div>
        ...
        <div className='min-h-screen fixed right-0 top-0 bottom-0 shadow-transparent bg-[#6183cd] px-5 py-10 md:min-w-[450px] success animate-slide-in-right translate-x-[6px] before:translate-x-[-66px] duration-150 transition-transform after:translate-x-[66px]'>
