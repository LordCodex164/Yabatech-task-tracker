        ...
        <form className="space-y-6 success px-[30px] py-[20px] border-[#cbcbc7] border-[1px]" >
         ...
         <div>
          ...
          <div className='flex flex-col gap-[20px]'>
            <button onClick={() => registerAdmin(name, email, password)} type='button' className="flex w-full justify-center rounded-md bg-gray-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Register as an admin</button>
            <button onClick={() => registerStaff(name, email, password)} type="submit" className="flex w-full justify-center rounded-md bg-gray-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Register as a staff</button>
          </div>
