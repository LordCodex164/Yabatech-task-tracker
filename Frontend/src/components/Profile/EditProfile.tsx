...
const EditProfile = ({userTasks, close}: {userTasks: userType, close: () => void}) => {
  ...
  return (
    <div className='fixed right-0 top-0 bottom-0 shadow-transparent bg-[#8996d7] px-5 py-10 z-50 min-w-[320px] md:min-w-[450px] animate-slide-in-right translate-x-[6px] before:translate-x-[-66px] duration-150 transition-transform after:translate-x-[66px]'>
    {/* let create the menu */}
